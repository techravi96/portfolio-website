...
const projects: Project[] = [
  ...
  { id: 8, name: "The Gold Class", tags: ["HTML", "CSS", "JS", "Wordpress"], image: goldclass, liveUrl: "https://thegoldclass.com/" },
  { id: 9, name: "Logihealth", tags: ["HTML", "CSS", "JS", "Bootstrap"], image: logihealth, liveUrl: "https://logihealth.de/" },
  { id: 10, name: "UPSC Akhada", tags: ["HTML", "CSS", "Next.JS", "React-Bootstrap"], image: upsc, liveUrl: "#" },
  { id: 11, name: "Emergent Solutions", tags: ["HTML", "CSS", "Bootstrap", "JS", "Next.JS"], image: emergent, liveUrl: "#" },
  { id: 12, name: "China Casting", tags: ["HTML", "CSS", "JS", "Bootstrap", "Wordpress"], image: chinaCasting, liveUrl: "https://www.china-casting.biz/" },
  { id: 13, name: "Step Cable", tags: ["HTML", "CSS", "JS", "Wordpress"], image: stepcable, liveUrl: "https://www.stepcable.com/" },
  { id: 14, name: "Sumitra Institute", tags: ["HTML", "CSS", "JS"], image: sumitra, liveUrl: "http://sumitrainstitute.com/" },
  { id: 15, name: "Genius Presentation", tags: ["HTML", "CSS", "JS", "Bootstrap"], image: genius, liveUrl: "http://geniuspresentation.in/" },
  { id: 16, name: "Explicit Leathers", tags: ["HTML", "CSS", "JS", "Bootstrap"], image: explicit, liveUrl: "http://explicitleathergroup.com/" },
];
